...
if (empty($cl['is_admin'])) {
	...
	if (empty($test_email) || empty(filter_var(trim($test_email), FILTER_VALIDATE_EMAIL))) {
		...
		$send_email_data   = array(
            ...
            'charSet'      => 'UTF-8',
            'is_html'      => false,
            'message_body' => "This is a test message that was sent to make sure that the SMTP server is working correctly. If you see this message, then your FriZone script is working and everything is OK"
        ); 
