			...
			<div class="row">
				<div class="col-sm-8 offset-sm-2">
					<div class="main-cont-header">
						...
						<h1>
							Welcome to the FriZone installer!
						</h1>
						<p>
							Installing <b>FriZone</b> quick easy. In just a few steps, you get a modern social media sharing platform
						</p>
					</div>
					...
					<div class="main-cont-footer">
						<span>
							Copyright &copy; <?php echo date('Y'); ?>. FriZone. All rights reserved. 
						</span>
					</div>
				</div>
			</div>
